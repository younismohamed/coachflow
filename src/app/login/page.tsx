    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-950 via-brand-900 to-brand-800 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-white/10 backdrop-blur rounded-2xl border border-white/20 mb-4">
          ...
          <p className="text-brand-200 mt-2 text-sm">Employee coaching management</p>
        </div>

        {/* Card */}
        <div className="bg-white rounded-2xl shadow-card-lg p-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-1">Welcome back</h2>
          <p className="text-gray-500 text-sm mb-6">Sign in with your company Google account to continue.</p>
          <GoogleLoginButton />
